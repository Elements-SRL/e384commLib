...
public:
    ...
    ErrorCodes_t setVoltageHalfTuner(std::vector<uint16_t> channelIndexes, std::vector<Measurement_t> voltages, bool applyFlagIn);
    ErrorCodes_t setCurrentHalfTuner(std::vector<uint16_t> channelIndexes, std::vector<Measurement_t> currents, bool applyFlagIn);
    ...
    ErrorCodes_t getVoltageHalfTunerFeatures(std::vector <RangedMeasurement_t> &voltageHalfTunerFeatures);
    ErrorCodes_t getCurrentHoldTunerFeatures(std::vector <RangedMeasurement_t> &currentHoldTunerFeatures);
    ErrorCodes_t getCurrentHalfTunerFeatures(std::vector <RangedMeasurement_t> &currentHalfTunerFeatures);
