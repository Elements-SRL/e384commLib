#ifndef EMCR24X1_MHZ_EL_5C4_PCBV_2_FWV_5_H
#define EMCR24X1_MHZ_EL_5C4_PCBV_2_FWV_5_H

#include "emcropalkellydevice.h"

class Emcr24x10MHz_EL05c4_PCBV02_FWV05 : public EmcrOpalKellyDevice {
public:
    Emcr24x10MHz_EL05c4_PCBV02_FWV05(std::string di);
