#ifndef EMCR8NPATCHCLAMP_EL_7E_ARTIX7_PCBV_2_H
#define EMCR8NPATCHCLAMP_EL_7E_ARTIX7_PCBV_2_H

#include "emcrftdidevice.h"

class Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01 : public EmcrFtdiDevice {
public:
    Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01(std::string di);
...
#endif // EMCR8NPATCHCLAMP_EL_7E_ARTIX7_PCBV_2_H
