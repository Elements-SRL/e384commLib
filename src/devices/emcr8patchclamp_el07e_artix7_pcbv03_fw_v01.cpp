...
Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01(std::string di) :
    EmcrFtdiDevice(di) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::initializeHW() {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::getCompensationEnables(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <bool> &onValues) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::enableVcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::enableCcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::setCompRanges(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <uint16_t> newRanges, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
std::vector <double> Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
...
std::vector <double> Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
...
ErrorCodes_t Emcr8PatchClamp_EL07e_artix7_PCBV03_fw_v01::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
