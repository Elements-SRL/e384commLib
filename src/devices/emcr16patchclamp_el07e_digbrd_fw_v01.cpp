...
Emcr16PatchClamp_EL07e_DigBrd_fw_v01::Emcr16PatchClamp_EL07e_DigBrd_fw_v01(std::string di) :
    ...
    vcCurrentFiltersArray[VCCurrentFilter6kHz].value = 6.0;
    ...
    ccVoltageFiltersArray[CCVoltageFilter6kHz].value = 6.0;
    ...
    boolConfig.initialWord = 917;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;

    doubleConfig.initialWord = 909;
    doubleConfig.initialBit = 0;
    ...
    boolConfig.initialWord = 928;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;

    doubleConfig.initialWord = 920;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    boolConfig.initialWord = 938;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 1;

    doubleConfig.initialWord = 930;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    for (int idx = 948; idx < 952; idx++) {
        txStatus.encodingWords[idx] = 0x1111; // rs bw avoid configuration with all zeros
    }
}

ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::initializeHW() {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::getCompensationEnables(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <bool> &onValues) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::enableVcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::enableCcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
std::vector <double> Emcr16PatchClamp_EL07e_DigBrd_fw_v01::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
...
std::vector <double> Emcr16PatchClamp_EL07e_DigBrd_fw_v01::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
...
ErrorCodes_t Emcr16PatchClamp_EL07e_DigBrd_fw_v01::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
