...
Emcr24x10MHz_EL05c1_PCBV02_FWV05::Emcr24x10MHz_EL05c1_PCBV02_FWV05(std::string di) :
    ...
    sr2LpfVcCurrentMap = {
        {SamplingRate781_25kHz, -1},
        {SamplingRate1_5625MHz, -1},
        {SamplingRate3_125MHz, -1},
        {SamplingRate6_25MHz, -1},
        {SamplingRate12_5MHz, -1},
        {SamplingRate25MHz, -1}
    };
    ...
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(2); /*! 6.3MHz  0b0010 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(1); /*! 13MHz   0b0001 */
    ...
    for (int idx = 0; idx <= CustomDacRefAsic3; ) {
...
ErrorCodes_t Emcr24x10MHz_EL05c1_PCBV02_FWV05::initializeHW() {
...
void Emcr24x10MHz_EL05c1_PCBV02_FWV05::setUserInfo(std::vector <uint8_t> userInfo) {
    macAddress = 0;
    for (int k = 0; k < 6; k++) {
        macAddress <<= 8;
