...
static const std::vector <std::vector <uint32_t>> deviceTupleMapping = {
    ...
    {DeviceVersionPrototype, DeviceSubversionProtoEl03F_4D, 131, DeviceEPatchEL03F_4D_PCBV02_V00},                  //  254,7,  131 : VC-CC prototype 2 chips (EL03F, EL04D) (legacy, to be removed)
    /*! ePatch EL03F-4E */
    ...
    {DeviceVersionE4p, DeviceSubversionEl07ABx8PatchLiner_artix7, 129, DeviceE8PPatchLinerEL07AB_artix7},           //  10, 8,  129 : VC-CC device with 8 channels (EL07AB) for Nanion's Patchliner (FPGA artix7). */
    /*! ePatch fake */
