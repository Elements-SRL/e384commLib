...
EZPatche4PEL04F::EZPatche4PEL04F(std::string di) :
    ...
    switchesNames[2][7] = "Power_ON";
    switchesNames[2][8] = "EN_NEGVDDA";
    switchesNames[2][9] = "EN_SWITCHING";
    switchesNames[2][10] = "EN_VDDD";
    switchesNames[2][11] = "EN_VDDA";
    switchesNames[2][12] = "EN_POSISOPW";
    switchesNames[2][13] = "EN_3V3ISO";
    switchesNames[2][14] = "EN_NEGISOPW";
    switchesNames[2][15] = "LED_BB";
    ...
    vcVoltageFiltersArray[VCStimulusLpf100Hz].value = 1.0;
...
EZPatche4PEL04F::~EZPatche4PEL04F() {

}

ErrorCodes_t EZPatche4PEL04F::setSamplingRate(uint16_t samplingRateIdx, bool applyFlag) {
    ErrorCodes_t ret;
...
ErrorCodes_t EZPatche4PEL04F::setLeakConductance(Measurement_t conductance) {
...
void EZPatche4PEL04F::selectVoltageOffsetResolution() {
    if (selectedVoltageSourceIdx == ChannelSourceVoltageFromVoltageClamp) {
...
void EZPatche4PEL04F::initializeCompensations() {
...
bool EZPatche4PEL04F::checkCompensationsValues() {
    bool ret = true;
...
bool EZPatche4PEL04F::fillCompensationsRegistersTxData(std::vector <uint16_t> &txDataMessage) {
...
void EZPatche4PEL04F::updateWrittenCompesantionValues(std::vector <uint16_t> &txDataMessage) {
