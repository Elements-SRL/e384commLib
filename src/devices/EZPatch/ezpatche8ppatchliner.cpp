...
EZPatche8PPatchliner::EZPatche8PPatchliner(std::string di) :
    ...
    switchesNames[7][0] = "CH5_VC_EN1";
    switchesNames[7][1] = "CH5_VC_EN2";
    switchesNames[7][2] = "CH5_CC_EN";
    switchesNames[7][3] = "CH5_CC_StimEN";
    switchesNames[7][4] = "CH5_VC_CfastEN";
    switchesNames[7][5] = "CH5_VC_CslowEN";
    switchesNames[7][6] = "CH5_VC_Corr_EN";
    switchesNames[7][7] = "CH5_VC_PredEN";
    switchesNames[7][8] = "CH5_VC_RLeakEN";
    switchesNames[7][9] = "CH5_VC_CorrBW";
    switchesNames[7][10] = "CH5_VC_Pred_range";
    switchesNames[7][11] = "CH5_CC_CfastEN";
    switchesNames[7][12] = "CH5_CC_BridgeDIS";
    switchesNames[7][13] = "CH5_Protocol_EN";
    switchesNames[7][14] = "free";
    switchesNames[7][15] = "free";

    switchesNames[8].resize(16);
    switchesNames[8][0] = "CH6_VC_EN1";
    switchesNames[8][1] = "CH6_VC_EN2";
    switchesNames[8][2] = "CH6_CC_EN";
    switchesNames[8][3] = "CH6_CC_StimEN";
    switchesNames[8][4] = "CH6_VC_CfastEN";
    switchesNames[8][5] = "CH6_VC_CslowEN";
    switchesNames[8][6] = "CH6_VC_Corr_EN";
    switchesNames[8][7] = "CH6_VC_PredEN";
    switchesNames[8][8] = "CH6_VC_RLeakEN";
    switchesNames[8][9] = "CH6_VC_CorrBW";
    switchesNames[8][10] = "CH6_VC_Pred_range";
    switchesNames[8][11] = "CH6_CC_CfastEN";
    switchesNames[8][12] = "CH6_CC_BridgeDIS";
    switchesNames[8][13] = "CH6_Protocol_EN";
    switchesNames[8][14] = "free";
    switchesNames[8][15] = "free";

    switchesNames[9].resize(16);
    switchesNames[9][0] = "CH7_VC_EN1";
    switchesNames[9][1] = "CH7_VC_EN2";
    switchesNames[9][2] = "CH7_CC_EN";
    switchesNames[9][3] = "CH7_CC_StimEN";
    switchesNames[9][4] = "CH7_VC_CfastEN";
    switchesNames[9][5] = "CH7_VC_CslowEN";
    switchesNames[9][6] = "CH7_VC_Corr_EN";
    switchesNames[9][7] = "CH7_VC_PredEN";
    switchesNames[9][8] = "CH7_VC_RLeakEN";
    switchesNames[9][9] = "CH7_VC_CorrBW";
    switchesNames[9][10] = "CH7_VC_Pred_range";
    switchesNames[9][11] = "CH7_CC_CfastEN";
    switchesNames[9][12] = "CH7_CC_BridgeDIS";
    switchesNames[9][13] = "CH7_Protocol_EN";
    switchesNames[9][14] = "free";
    switchesNames[9][15] = "free";

    switchesNames[10].resize(16);
    switchesNames[10][0] = "CH8_VC_EN1";
    switchesNames[10][1] = "CH8_VC_EN2";
    switchesNames[10][2] = "CH8_CC_EN";
    switchesNames[10][3] = "CH8_CC_StimEN";
    switchesNames[10][4] = "CH8_VC_CfastEN";
    switchesNames[10][5] = "CH8_VC_CslowEN";
    switchesNames[10][6] = "CH8_VC_Corr_EN";
    switchesNames[10][7] = "CH8_VC_PredEN";
    switchesNames[10][8] = "CH8_VC_RLeakEN";
    switchesNames[10][9] = "CH8_VC_CorrBW";
    switchesNames[10][10] = "CH8_VC_Pred_range";
    switchesNames[10][11] = "CH8_CC_CfastEN";
    switchesNames[10][12] = "CH8_CC_BridgeDIS";
    switchesNames[10][13] = "CH8_Protocol_EN";
    switchesNames[10][14] = "free";
    switchesNames[10][15] = "free";
...
//    ccStimulusLpfSwitchesLutStrings[CCStimulusLpf10kHz] = "01";
    ...
    constantSwitchesWord[ConstantSwitchCh5VcEn1] = 7;
    constantSwitchesWord[ConstantSwitchCh5VcCorrBw] = 7;
    constantSwitchesWord[ConstantSwitchCh5PredRange] = 7;
    constantSwitchesWord[ConstantSwitchCh6VcEn1] = 8;
    constantSwitchesWord[ConstantSwitchCh6VcCorrBw] = 8;
    constantSwitchesWord[ConstantSwitchCh6PredRange] = 8;
    constantSwitchesWord[ConstantSwitchCh7VcEn1] = 9;
    constantSwitchesWord[ConstantSwitchCh7VcCorrBw] = 9;
    constantSwitchesWord[ConstantSwitchCh7PredRange] = 9;
    constantSwitchesWord[ConstantSwitchCh8VcEn1] = 10;
    constantSwitchesWord[ConstantSwitchCh8VcCorrBw] = 10;
    constantSwitchesWord[ConstantSwitchCh8PredRange] = 10;
    ...
    constantSwitchesByte[ConstantSwitchCh5VcEn1] = 0x0001;
    constantSwitchesByte[ConstantSwitchCh5VcCorrBw] = 0x0200;
    constantSwitchesByte[ConstantSwitchCh5PredRange] = 0x0400;
    constantSwitchesByte[ConstantSwitchCh6VcEn1] = 0x0001;
    constantSwitchesByte[ConstantSwitchCh6VcCorrBw] = 0x0200;
    constantSwitchesByte[ConstantSwitchCh6PredRange] = 0x0400;
    constantSwitchesByte[ConstantSwitchCh7VcEn1] = 0x0001;
    constantSwitchesByte[ConstantSwitchCh7VcCorrBw] = 0x0200;
    constantSwitchesByte[ConstantSwitchCh7PredRange] = 0x0400;
    constantSwitchesByte[ConstantSwitchCh8VcEn1] = 0x0001;
    constantSwitchesByte[ConstantSwitchCh8VcCorrBw] = 0x0200;
    constantSwitchesByte[ConstantSwitchCh8PredRange] = 0x0400;
...
EZPatche8PPatchliner::~EZPatche8PPatchliner() {
...
ErrorCodes_t EZPatche8PPatchliner::hasCompFeature(CompensationUserParams feature) {
    switch (feature) {
    case U_CpVc:
    case U_Cm:
    case U_Rs:
...
ErrorCodes_t EZPatche8PPatchliner::setLeakConductance(Measurement_t conductance) {
...
ErrorCodes_t EZPatche8PPatchliner::getLeakConductanceControl(CompensationControl_t &control) {
...
bool EZPatche8PPatchliner::fillCompensationsRegistersTxData(std::vector <uint16_t> &txDataMessage) {
    ...
    txDataMessage[1] = 0xFF-((vcCompensationsActivated & compCfastEnable[compensationsSettingChannel]) ? (uint16_t)round(compensationControls[U_CpVc][compensationsSettingChannel].value/pipetteCapacitanceStep) : 0);
    txDataMessage[2] = CompensationsRegisterVCCSlowGain+compensationsSettingChannel*coreSpecificRegistersNum;
    txDataMessage[3] = 0xFF-((vcCompensationsActivated & compCslowEnable[compensationsSettingChannel]) ? (uint16_t)round(highMembraneCapacitanceFlag ? (compensationControls[U_Cm][compensationsSettingChannel].value-minMembraneCapacitance2)/membraneCapacitanceStep2 : (compensationControls[U_Cm][compensationsSettingChannel].value-minMembraneCapacitance1)/membraneCapacitanceStep1) : 0)+(highMembraneCapacitanceFlag ? 0x0100 : 0);
    txDataMessage[4] = CompensationsRegisterVCCslowTau+compensationsSettingChannel*coreSpecificRegistersNum;
    txDataMessage[5] = 0xFF-((vcCompensationsActivated & compCslowEnable[compensationsSettingChannel]) ? (uint16_t)round((compensationControls[U_Cm][compensationsSettingChannel].value*compensationControls[U_Rs][compensationsSettingChannel].value-minMembraneTau)/membraneTauStep) : 0);
    txDataMessage[6] = CompensationsRegisterVCRCorrGain+compensationsSettingChannel*coreSpecificRegistersNum;
    txDataMessage[7] = 0xFF-((vcCompensationsActivated & compRsCorrEnable[compensationsSettingChannel]) ? (uint16_t)round(compensationControls[U_RsCp][compensationsSettingChannel].value/maxResistanceCorrectionPercentage*compensationControls[U_Rs][compensationsSettingChannel].value/resistanceCorrectionStep) : 0);
    ...
    if (selectedVcCurrentRangeIdx < VCCurrentRange30nA) {
        ...
        txDataMessage[11] = 0xFF-((vcCompensationsActivated & compLeakEnable[compensationsSettingChannel]) ? (uint16_t)round((compensationControls[U_LkG][compensationsSettingChannel].value-minLeakConductanceHigh)/leakConductanceHighStep) : 0);
    }
    txDataMessage[12] = CompensationsRegisterCCCFastGain+compensationsSettingChannel*coreSpecificRegistersNum;
    txDataMessage[13] = 0xFF-((ccCompensationsActivated & compCcCfastEnable[compensationsSettingChannel]) ? (uint16_t)round(compensationControls[U_CpCc][compensationsSettingChannel].value/ccPipetteCapacitanceStep) : 0);
    txDataMessage[14] = CompensationsRegisterCCBridgeGain+compensationsSettingChannel*coreSpecificRegistersNum;
    txDataMessage[15] = 0xFF-((ccCompensationsActivated & compCcBridgeEnable[compensationsSettingChannel]) ? (uint16_t)round((compensationControls[U_BrB][compensationsSettingChannel].value-minBridgeBalanceResistance)/bridgeBalanceResistanceStep) : 0);
...
void EZPatche8PPatchliner::updateWrittenCompesantionValues(std::vector <uint16_t> &txDataMessage) {
