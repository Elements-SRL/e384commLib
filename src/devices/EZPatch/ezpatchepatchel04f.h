#ifndef EZPATCHEPATCHEL04F_H
#define EZPATCHEPATCHEL04F_H

#include "ezpatchftdidevice.h"

class EZPatchePatchEL04F : public EZPatchFtdiDevice {
public:
    EZPatchePatchEL04F(std::string di);
    virtual ~EZPatchePatchEL04F();
