...
EZPatche8PPatch_el07cd_artix7_PCBV01::EZPatche8PPatch_el07cd_artix7_PCBV01(std::string di) :
...
ErrorCodes_t EZPatche8PPatch_el07cd_artix7_PCBV01::setSamplingRate(uint16_t samplingRateIdx, bool applyFlag) {
...
void EZPatche8PPatch_el07cd_artix7_PCBV01::selectChannelsResolutions() {
...
void EZPatche8PPatch_el07cd_artix7_PCBV01::selectVoltageOffsetResolution() {
    if (selectedSourceForVoltageChannelIdx == ChannelSourceVoltageFromVoltageClamp) {
...
void EZPatche8PPatch_el07cd_artix7_PCBV01::initializeCompensations() {
...
bool EZPatche8PPatch_el07cd_artix7_PCBV01::checkCompensationsValues() {
    bool ret = true;
...
bool EZPatche8PPatch_el07cd_artix7_PCBV01::fillCompensationsRegistersTxData(std::vector <uint16_t> &txDataMessage) {
...
void EZPatche8PPatch_el07cd_artix7_PCBV01::updateWrittenCompensationValues(std::vector <uint16_t> &txDataMessage) {
    if (vcCompensationsActivated) {
...
EZPatche8PPatch_el07cd_artix7_PCBV02::EZPatche8PPatch_el07cd_artix7_PCBV02(std::string di) :
    EZPatche8PPatch_el07cd_artix7_PCBV01(di) {
