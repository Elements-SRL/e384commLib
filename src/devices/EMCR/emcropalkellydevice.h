...
#define OKY_READ_CAL_EEPROM_TRIGGER_IN_BIT 6
#define OKY_GET_CAL_RAM_TRIGGER_IN_ADDR 0x53
#define OKY_GET_CAL_RAM_TRIGGER_IN_BIT 7
#define OKY_SET_CAL_RAM_TRIGGER_IN_ADDR 0x53
#define OKY_SET_CAL_RAM_TRIGGER_IN_BIT 8
#define OKY_WRITE_CAL_EEPROM_TRIGGER_IN_ADDR 0x53
#define OKY_WRITE_CAL_EEPROM_TRIGGER_IN_BIT 9
