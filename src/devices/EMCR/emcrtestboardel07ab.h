#ifndef EMCRTESTBOARDEL07AB_H
#define EMCRTESTBOARDEL07AB_H

#include "emcropalkellydevice.h"

class EmcrTestBoardEl07ab : public EmcrOpalKellyDevice {
public:
    EmcrTestBoardEl07ab(std::string di);
...
//        ChannelSourceVoltageFromVoltagePlusDynamicClamp = 3,
    ...
    virtual double computeAsicCmCinj(double cm, bool chanCslowEnable, MultiCoder::CoderConfig_t multiconfigCslow);

    virtual ErrorCodes_t getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) override;
};

#endif // EMCRTESTBOARDEL07AB_H
