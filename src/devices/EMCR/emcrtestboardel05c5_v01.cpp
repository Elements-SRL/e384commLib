...
EmcrTestBoardEl05c5TransistorFeSingleEndedOut::EmcrTestBoardEl05c5TransistorFeSingleEndedOut(std::string di) :
    EmcrOpalKellyDevice(di) {

    deviceName = "EL05c5TestBoard";
    ...
    txDataWords = 263; /*! \todo FCON AGGIORNARE MAN MANO CHE SI AGGIUNGONO CAMPI */
    ...
    vcCurrentRangesArray[VCCurrentRange1uA].min = -1.0;
    vcCurrentRangesArray[VCCurrentRange1uA].max = 1.0;
    vcCurrentRangesArray[VCCurrentRange1uA].step = vcCurrentRangesArray[VCCurrentRange1uA].max/SHORT_MAX;
    vcCurrentRangesArray[VCCurrentRange1uA].prefix = UnitPfxMicro;
    vcCurrentRangesArray[VCCurrentRange1uA].unit = "A";
    ...
    txStatus.encodingWords[0] = 0x0020; /*! inverting front end */
    txStatus.encodingWords[1] = 0x0002; /*! ADC power enable override */
    txStatus.encodingWords[3] = 0x0004; /*! Select FE */
    txStatus.encodingWords[259] = 0x4000; /*! current gain 1 */
    txStatus.encodingWords[261] = 0x4000; /*! voltage gain 1 */
}

ErrorCodes_t EmcrTestBoardEl05c5TransistorFeSingleEndedOut::initializeHW() {
...
EmcrTestBoardEl05c5ResistiveFeSingleEndedOut::EmcrTestBoardEl05c5ResistiveFeSingleEndedOut(std::string di) :
    EmcrOpalKellyDevice(di) {
    ...
    vcCurrentRangesArray[VCCurrentRange1uA].prefix = UnitPfxMicro;
    vcCurrentRangesArray[VCCurrentRange1uA].unit = "A";
    vcCurrentRangesArray[VCCurrentRange10uA].min = -10.0;
    vcCurrentRangesArray[VCCurrentRange10uA].max = 10.0;
    vcCurrentRangesArray[VCCurrentRange10uA].step = vcCurrentRangesArray[VCCurrentRange10uA].max/SHORT_MAX;
    vcCurrentRangesArray[VCCurrentRange10uA].prefix = UnitPfxMicro;
    vcCurrentRangesArray[VCCurrentRange10uA].unit = "A";
    defaultVcCurrentRangeIdxs.resize(1);
    defaultVcCurrentRangeIdxs[0] = VCCurrentRange100nA;
    ...
    /*! Default status */
    txStatus.init(txDataWords);
    txStatus.encodingWords[0] = 0x0000; /*! inverting front end */
    txStatus.encodingWords[1] = 0x0002; /*! ADC power enable override */
    txStatus.encodingWords[3] = 0x0008; /*! Select FE */
    txStatus.encodingWords[259] = 0x4000; /*! current gain 1 */
    txStatus.encodingWords[261] = 0x4000; /*! voltage gain 1 */
}

ErrorCodes_t EmcrTestBoardEl05c5ResistiveFeSingleEndedOut::initializeHW() {
    this->resetFpga(true, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
    this->resetFpga(false, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
...
EmcrTestBoardEl05c5TransistorFeDifferentialOut::EmcrTestBoardEl05c5TransistorFeDifferentialOut(std::string di) :
    EmcrOpalKellyDevice(di) {
    ...
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 4;
    vcCurrentFilterCoder = new BoolNegatedArrayCoder(boolConfig);
    coders.push_back(vcCurrentFilterCoder);
    ...
    txStatus.encodingWords[0] = 0x0000; /*! inverting front end */
    txStatus.encodingWords[1] = 0x0002; /*! ADC power enable override */
    txStatus.encodingWords[3] = 0x0010; /*! Select FE */
    txStatus.encodingWords[259] = 0x4000; /*! current gain 1 */
    txStatus.encodingWords[261] = 0x4000; /*! voltage gain 1 */
}

ErrorCodes_t EmcrTestBoardEl05c5TransistorFeDifferentialOut::initializeHW() {
    this->resetFpga(true, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
    this->resetFpga(false, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
...
EmcrTestBoardEl05c5ResistiveFeDifferentialOut::EmcrTestBoardEl05c5ResistiveFeDifferentialOut(std::string di) :
    EmcrOpalKellyDevice(di) {
    ...
    txStatus.encodingWords[0] = 0x0020; /*! inverting front end */
    txStatus.encodingWords[1] = 0x0002; /*! ADC power enable override */
    txStatus.encodingWords[3] = 0x0020; /*! Select FE */
    txStatus.encodingWords[259] = 0x4000; /*! current gain 1 */
    txStatus.encodingWords[261] = 0x4000; /*! voltage gain 1 */
}

ErrorCodes_t EmcrTestBoardEl05c5ResistiveFeDifferentialOut::initializeHW() {
    this->resetFpga(true, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
    this->resetFpga(false, true);
    std::this_thread::sleep_for (std::chrono::milliseconds(100));
