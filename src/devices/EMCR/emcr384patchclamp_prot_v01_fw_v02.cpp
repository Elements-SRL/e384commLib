...
ErrorCodes_t Emcr384PatchClamp_prot_v01_fw_v02::getCompensationEnables(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <bool> &onValues) {
    switch (type) {
    case CompCfast:
...
double Emcr384PatchClamp_prot_v01_fw_v02::computeAsicCmCinj(double cm, bool chanCslowEnable, MultiCoder::CoderConfig_t multiconfigCslow) {
    bool done = false;
    int i;
    double asicCmCinj;
...
ErrorCodes_t Emcr384PatchClamp_prot_v01_fw_v02::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
