...
Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::Emcr192Blm_EL03c_Mb03_Mez04_fw_v01(std::string di) :
...
ErrorCodes_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::setCoolingFansSpeed(Measurement_t speed, bool applyFlag) {
...
ErrorCodes_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::getCoolingFansSpeedRange(RangedMeasurement_t &range) {
    range = {0.0, fanTrimmerWMax.value, 10.0, fanTrimmerWMax.prefix, fanTrimmerWMax.unit};
    return Success;
}

ErrorCodes_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::setTemperatureControl(Measurement_t temperature, bool enabled) {
...
ErrorCodes_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::setTemperatureControlPid(PidParams_t params) {
...
void Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::processTemperatureData(std::vector <Measurement_t> temperaturesRead) {
...
Measurement_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::fanV2R(Measurement_t V) {
    V.convertValue(fanTrimmerVRef.prefix);
    return fanTrimmerRf*(V.value/fanTrimmerVRef.value-1.0);
}

Measurement_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::fanW2V(Measurement_t W) {
    W.convertValue(fanTrimmerWMax.prefix);
    return fanTrimmerVMax*(W.value/fanTrimmerWMax.value);
}

Measurement_t Emcr192Blm_EL03c_Mb03_Mez04_fw_v01::fanRT2W(Measurement_t RT) {
