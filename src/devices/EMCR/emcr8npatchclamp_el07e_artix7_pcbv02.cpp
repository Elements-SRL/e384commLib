...
Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01(std::string di) :
    EmcrFtdiDevice(di) {
    ...
    boolConfig.initialWord = 1093;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;

    doubleConfig.initialWord = 1089;
    doubleConfig.initialBit = 0;
    ...
    boolConfig.initialWord = 1099;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;

    doubleConfig.initialWord = 1095;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    boolConfig.initialWord = 1104;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 1;

    doubleConfig.initialWord = 1100;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    txStatus.encodingWords[1079] = 0x4040;
    txStatus.encodingWords[1110] = 0x1111; // rs bw avoid configuration with all zeros
    txStatus.encodingWords[1111] = 0x1111;
}

ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::initializeHW() {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::enableVcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::enableCcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::setCompRanges(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <uint16_t> newRanges, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::setCoolingFansSpeed(Measurement_t speed, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::getCoolingFansSpeedRange(RangedMeasurement_t &range) {
    range = {0.0, fanTrimmerWMax.value, 10.0, fanTrimmerWMax.prefix, fanTrimmerWMax.unit};
    return Success;
}

std::vector <double> Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
...
std::vector <double> Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
...
Measurement_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::fanV2R(Measurement_t V) {
    V.convertValue(fanTrimmerVRef.prefix);
    return fanTrimmerRf*(V.value/fanTrimmerVRef.value-1.0);
}

Measurement_t Emcr8nPatchClamp_EL07e_artix7_PCBV02_fw_v01::fanW2V(Measurement_t W) {
