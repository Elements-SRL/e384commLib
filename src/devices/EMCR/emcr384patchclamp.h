...
public:
    ...
    virtual ErrorCodes_t enableVcCompensations(bool enable, bool applyFlagIn) override;
    virtual ErrorCodes_t enableCcCompensations(bool enable, bool applyFlagIn) override;
