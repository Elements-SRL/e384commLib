#ifndef EMCR24X1_MHZ_EL_5C3_PCBV_2_H
#define EMCR24X1_MHZ_EL_5C3_PCBV_2_H

#include "emcropalkellydevice.h"

class Emcr24x10MHz_EL05c3_PCBV02 : public EmcrOpalKellyDevice {
public:
    Emcr24x10MHz_EL05c3_PCBV02(std::string di);
...
#endif // EMCR24X1_MHZ_EL_5C3_PCBV_2_H
