...
Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01(std::string di) :
    EmcrFtdiDevice(di) {
    ...
    for (int idx = 0; idx < pipetteCapacitanceRanges; idx++) {
        ...
        ccPipetteCapacitanceRange[idx].min = (4.0*(pipetteVarConductance/pipetteCapacitanceValuesNum+1.0/pipetteFixedResistance1)*pipetteFixedResistance2+3.0)*pipetteInjCapacitance[idx]-additionalInputCapacitance;
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::initializeHW() {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::getCompensationEnables(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <bool> &onValues) {
    switch (type) {
    case CompCfast:
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::enableVcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::enableCcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::setCompRanges(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <uint16_t> newRanges, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::setCoolingFansSpeed(Measurement_t speed, bool applyFlag) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::getCoolingFansSpeedRange(RangedMeasurement_t &range) {
    range = {0.0, fanTrimmerWMax.value, 10.0, fanTrimmerWMax.prefix, fanTrimmerWMax.unit};
    return Success;
}

std::vector <double> Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
...
std::vector <double> Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
...
ErrorCodes_t Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
...
void Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01::setGrEn(bool flag, bool applyFlag) {
