...
Emcr384PatchClamp_EL07e_fw_v05::Emcr384PatchClamp_EL07e_fw_v05(std::string di) :
    ...
    boolConfig.initialWord = 4432;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;

    doubleConfig.initialWord = 4240;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    boolConfig.initialWord = 4672;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 1;

    doubleConfig.initialWord = 4480;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 8;
    ...
    for (int idx = 4912; idx < 5008; idx++) {
        txStatus.encodingWords[idx] = 0x1111; // rs bw avoid configuration with all zeros
    }
}

ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::initializeHW() {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::getCompensationEnables(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <bool> &onValues) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::enableVcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::enableCcCompensations(bool enable, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
std::vector <double> Emcr384PatchClamp_EL07e_fw_v05::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
...
std::vector <double> Emcr384PatchClamp_EL07e_fw_v05::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::setCoolingFansSpeed(Measurement_t speed, bool applyFlag) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::getCoolingFansSpeedRange(RangedMeasurement_t &range) {
    range = {0.0, fanTrimmerWMax.value, 10.0, fanTrimmerWMax.prefix, fanTrimmerWMax.unit};
    return Success;
}

ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::setTemperatureControl(Measurement_t temperature, bool enabled) {
...
ErrorCodes_t Emcr384PatchClamp_EL07e_fw_v05::setTemperatureControlPid(PidParams_t params) {
...
void Emcr384PatchClamp_EL07e_fw_v05::processTemperatureData(std::vector <Measurement_t> temperaturesRead) {
...
Measurement_t Emcr384PatchClamp_EL07e_fw_v05::fanV2R(Measurement_t V) {
    V.convertValue(fanTrimmerVRef.prefix);
    return fanTrimmerRf*(V.value/fanTrimmerVRef.value-1.0);
}

Measurement_t Emcr384PatchClamp_EL07e_fw_v05::fanW2V(Measurement_t W) {
    W.convertValue(fanTrimmerWMax.prefix);
    return fanTrimmerVMax*(W.value/fanTrimmerWMax.value);
}

Measurement_t Emcr384PatchClamp_EL07e_fw_v05::fanRT2W(Measurement_t RT) {
