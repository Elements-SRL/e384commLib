...
EmcrQc01aTB_PCBV02::EmcrQc01aTB_PCBV02(std::string di) :
    ...
    customFlagsNames[AcDsEn] = "Enable delta sigma for AC";
    customFlagsNames[DcDsEn] = "Enable delta sigma for DC";
    customFlagsNames[DcSepEn] = "Separate DC";
    customFlagsDefault.resize(customFlagsNum);
    customFlagsDefault[AcDsEn] = true;
    customFlagsDefault[DcDsEn] = true;
    customFlagsDefault[DcSepEn] = false;
    customFlagsCoders.resize(customFlagsNum);
    boolConfig.initialWord = 1;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;
    customFlagsCoders[AcDsEn] = new BoolRandomArrayCoder(boolConfig);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[AcDsEn])->addMapItem(0);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[AcDsEn])->addMapItem(3);
    coders.push_back(customFlagsCoders[AcDsEn]);
    boolConfig.initialWord = 1;
    boolConfig.initialBit = 2;
    boolConfig.bitsNum = 2;
    customFlagsCoders[DcDsEn] = new BoolRandomArrayCoder(boolConfig);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[DcDsEn])->addMapItem(0);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[DcDsEn])->addMapItem(3);
    coders.push_back(customFlagsCoders[DcDsEn]);
    boolConfig.initialWord = 2;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;
    customFlagsCoders[DcSepEn] = new BoolRandomArrayCoder(boolConfig);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[DcSepEn])->addMapItem(0);
    static_cast <BoolRandomArrayCoder *> (customFlagsCoders[DcSepEn])->addMapItem(3);
    coders.push_back(customFlagsCoders[DcSepEn]);
...
ErrorCodes_t EmcrQc01aTB_PCBV02::setVoltageReference(Measurement_t voltage, bool applyFlag) {
