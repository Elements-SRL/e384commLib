...
Emcr8Blm_EL03c_DigBrd_fw_v01::Emcr8Blm_EL03c_DigBrd_fw_v01(std::string di) :
    ...
    sr2LpfVcCurrentMap = {
        ...
        {SamplingRate2_5kHz, VCCurrentFilter16kHz},
    ...
    for (int c = 275; c < 283; c++) {
        txStatus.encodingWords[c] = 0x4000; // ODAC gain one
    }
}

ErrorCodes_t Emcr8Blm_EL03c_DigBrd_fw_v01::initializeHW() {
