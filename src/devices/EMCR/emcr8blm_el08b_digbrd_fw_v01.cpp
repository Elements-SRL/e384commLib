...
Emcr8Blm_EL08b_DigBrd_fw_v01::Emcr8Blm_EL08b_DigBrd_fw_v01(std::string di) :
    ...
    vcCurrentRangesArray[VCCurrentRange1nA].step = vcCurrentRangesArray[VCCurrentRange1nA].max/(SHORT_MAX+1.0);
    ...
    vcCurrentRangesArray[VCCurrentRange100nA].step = vcCurrentRangesArray[VCCurrentRange100nA].max/(SHORT_MAX+1.0);
    ...
    vcCurrentRangesArray[VCCurrentRange1uA].step = vcCurrentRangesArray[VCCurrentRange1uA].max/(SHORT_MAX+1.0);
    ...
    defaultVcCurrentRangeIdxs[0] = VCCurrentRange1nA;
    ...
    sr2srm[SamplingRate2_5kHz] = 0;
    sr2srm[SamplingRate5kHz] = 1;
    sr2srm[SamplingRate10kHz] = 1;
    sr2srm[SamplingRate20kHz] = 2;
    sr2srm[SamplingRate50kHz] = 2;
    sr2srm[SamplingRate100kHz] = 3;
    sr2srm[SamplingRate200kHz] = 3;
    ...
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(48);  /*!<  1.25kHz BW CK/8 -> 0b110000 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(49);  /*!<  2.5kHz  BW CK/8 -> 0b110001 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(34);  /*!<  5kHz    BW CK/4 -> 0b100010 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(35);  /*!<  10kHz   BW CK/4 -> 0b100011 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(20);  /*!<  20kHz   BW CK/2 -> 0b010100 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(21);  /*!<  50kHz   BW CK/2 -> 0b010101 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(6);   /*!<  100kHz  BW CK/1 -> 0b000110 */
    static_cast <BoolRandomArrayCoder *> (samplingRateCoder)->addMapItem(7);   /*!<  200kHz  BW CK/1 -> 0b000111 */
    ...
    static_cast <BoolRandomArrayCoder *> (vcVoltageFilterCoder)->addMapItem(1);
...
ErrorCodes_t Emcr8Blm_EL08b_DigBrd_fw_v01::initializeHW() {
