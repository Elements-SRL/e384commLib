...
Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03(std::string di) :
    EmcrFtdiDevice(di) {
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::initializeHW() {
    std::this_thread::sleep_for (std::chrono::seconds(motherboardBootTime_s));
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::getCompOptionsFeatures(CompensationTypes_t type, std::vector <std::string> &compOptionsArray) {
    switch (type) {
    case CompRsCorr:
        if (rsCorrBwArray.size()==0) {
            return ErrorFeatureNotImplemented;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::enableCompensation(std::vector <uint16_t> channelIndexes, CompensationTypes_t compTypeToEnable, std::vector <bool> onValues, bool applyFlag) {
    switch (compTypeToEnable) {
    case CompCfast:
        if (pipetteCapEnCompensationCoders.size() == 0) {
            return ErrorFeatureNotImplemented;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::enableVcCompensations(bool enable, bool applyFlag) {
    vcCompensationsActivated = enable;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::enableCcCompensations(bool enable, bool applyFlag) {
    ccCompensationsActivated = enable;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::setCompValues(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <double> newParamValues, bool applyFlag) {
    std::vector <std::vector <double> > localCompValueSubMatrix;
    localCompValueSubMatrix.resize(channelIndexes.size());
    for (int chIdx = 0; chIdx < channelIndexes.size(); chIdx++) {
        localCompValueSubMatrix[chIdx] = this->compValueMatrix[channelIndexes[chIdx]];
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::setCompRanges(std::vector <uint16_t> channelIndexes, CompensationUserParams_t paramToUpdate, std::vector <uint16_t> newRanges, bool applyFlag) {
    if (compValueMatrix.empty()) {
        return ErrorFeatureNotImplemented;
    }
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::setCompOptions(std::vector <uint16_t> channelIndexes, CompensationTypes_t type, std::vector <uint16_t> options, bool applyFlag) {
    switch (type) {
    case CompRsCorr:
        if (rsCorrBwCompensationCoders.empty()) {
            return ErrorFeatureNotImplemented;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::turnVoltageReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::turnCurrentReaderOn(bool onValueIn, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
    std::vector <ClampingModality_t> clamps(currentChannelsNum);
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::turnVoltageStimulusOn(bool onValue, bool applyFlag) {
    if (onValue) {
        this->updateCalibVcVoltageGain(allChannelIndexes, false);
        this->updateCalibVcVoltageOffset(allChannelIndexes, applyFlag);
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::turnCurrentStimulusOn(bool onValue, bool applyFlag) {
    std::vector <bool> trues(currentChannelsNum);
    std::vector <bool> falses(currentChannelsNum);
...
std::vector <double> Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::user2AsicDomainTransform(int chIdx, std::vector <double> userDomainParams) {
    std::vector <double> asicDomainParameter;
    asicDomainParameter.resize(CompensationAsicParamsNum);
    double cp; // pipette capacitance
    double cm; // membrane capacitance
...
std::vector <double> Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::asic2UserDomainTransform(int chIdx, std::vector <double> asicDomainParams, double oldUCpVc, double oldUCpCc) {
    std::vector <double> userDomainParameter;
    userDomainParameter.resize(CompensationUserParamsNum);
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::asic2UserDomainCompensable(int chIdx, std::vector <double> asicDomainParams, std::vector <double> userDomainParams) {
    /*! \todo still to understand how to obtain them. COuld they be imputs of the function?*/
    std::vector <double> potentialMaxs;
    std::vector <double> potentialMins;
...
ErrorCodes_t Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::getCompensationControl(CompensationUserParams_t param, CompensationControl_t &control) {
    switch (param) {
    case U_CpVc:
        control.implemented = true;
        control.min = pipetteCapacitanceRange.front().min;
...
void Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v03::setGrEn(bool flag, bool applyFlag) {
    for (auto coder : grEnCoders) {
        coder->encode(flag, txStatus);
    }
    if (applyFlag) {
...
Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v02::Emcr8PatchClamp_EL07c_artix7_PCBV01_fw_v02(std::string di) :
