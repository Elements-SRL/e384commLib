#ifndef EMCR8NPATCHCLAMP_EL_7C_ARTIX7_PCBV_1_H
#define EMCR8NPATCHCLAMP_EL_7C_ARTIX7_PCBV_1_H

#include "emcrftdidevice.h"

class Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01 : public EmcrFtdiDevice {
public:
    Emcr8nPatchClamp_EL07c_artix7_PCBV01_fw_v01(std::string di);
