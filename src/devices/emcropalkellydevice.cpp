...
#include "emcr24x10mhz_el05c1_pcbv02_fwv05.h"
#include "emcr24x10mhz_el05c3_pcbv02_fwv05.h"
#include "emcr24x10mhz_el05c4_pcbv02_fwv05.h"
#include "emcr24x10mhz_only8ch.h"
...
static const std::vector <std::vector <uint32_t> > deviceTupleMapping = {
    ...
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c1_PCBV02, 4, Device24x10MHz_PCBV02_EL05c1},                                //   11, 17,  4 : 24 channels 10MHz nanopore reader, EL05c1
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c3_PCBV02, 4, Device24x10MHz_PCBV02_EL05c3},                                //   11, 18,  4 : 24 channels 10MHz nanopore reader, EL05c3
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c4_PCBV02, 4, Device24x10MHz_PCBV02_EL05c4},                                //   11, 19,  4 : 24 channels 10MHz nanopore reader, EL05c4
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c1_PCBV02, 5, Device24x10MHz_PCBV02_EL05c1_FWV05},                          //   11, 17,  5 : 24 channels 10MHz nanopore reader, EL05c1
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c3_PCBV02, 5, Device24x10MHz_PCBV02_EL05c3_FWV05},                          //   11, 18,  5 : 24 channels 10MHz nanopore reader, EL05c3
    {EmcrOpalKellyDevice::DeviceVersion10MHz, EmcrOpalKellyDevice::DeviceSubversion24x10MHz_EL05c4_PCBV02, 5, Device24x10MHz_PCBV02_EL05c4_FWV05},                          //   11, 19,  5 : 24 channels 10MHz nanopore reader, EL05c4
    ...
    {EmcrOpalKellyDevice::DeviceVersion384Patch, EmcrOpalKellyDevice::DeviceSubversion16Patch_EL07e_DigitalTester_PCBV01b, 1, Device16PatchClamp_el07e_digitalTesterfw_v01},//   15,  6,  1 : 16-channel device consisting of a single 16-channels analog board
    {EmcrOpalKellyDevice::DeviceVersion384Patch, EmcrOpalKellyDevice::DeviceSubversion384Patch_EL07e_MB03Mez05An05, 5, Device384PatchClamp_el07e_fw_v05},                   //   15,  7,  5 : 384-channel EL07e (Analog V05, Motherboard V03, Mezzanine V05)
    {EmcrOpalKellyDevice::DeviceVersion384Patch, EmcrOpalKellyDevice::DeviceSubversion384Patch_EL07e_MB03Mez05An05, 6, Device384PatchClamp_el07e_fw_v06},                   //   15,  7,  6 : 384-channel EL07e (Analog V05, Motherboard V03, Mezzanine V05)
    {EmcrOpalKellyDevice::DeviceVersion384Patch, EmcrOpalKellyDevice::DeviceSubversion384Patch_EL07e_MB03Mez05An05, 7, Device384PatchClamp_el07e_fw_v07},                   //   15,  7,  7 : 384-channel EL07e (Analog V05, Motherboard V03, Mezzanine V05)
    ...
    {EmcrOpalKellyDevice::DeviceVersionTestBoard, EmcrOpalKellyDevice::DeviceSubversionTestBoardEL07b, 1, DeviceTestBoardEL07ab},                                           //    6, 18,  1 : EL07b test board
...
ErrorCodes_t EmcrOpalKellyDevice::connectDevice(std::string deviceId, MessageDispatcher * &messageDispatcher, std::string fwPath) {
    ...
    switch (deviceType) {
    case Device192Blm_el03c_mb02_mez03_fw_v01:
        messageDispatcher = new Emcr192Blm_EL03c_Mb02_Mez03_fw_v01(deviceId);
        break;

    case Device192Blm_el03c_mb02_mez03_fw_v02:
        messageDispatcher = new Emcr192Blm_EL03c_Mb02_Mez03_fw_v02(deviceId);
        break;

    case Device192Blm_el03c_mb02_mez03_fw_v03:
        messageDispatcher = new Emcr192Blm_EL03c_Mb02_Mez03_fw_v03(deviceId);
        break;

    case Device192Blm_el03c_mb02_mez03_fw_v04:
    ...
    case Device192Blm_el03c_mb03_mez04_fw_v02:
        messageDispatcher = new Emcr192Blm_EL03c_Mb03_Mez04_fw_v02(deviceId);
        break;

    case Device192Blm_el03c_mb03_mez04_fw_v03:
        messageDispatcher = new Emcr192Blm_EL03c_Mb03_Mez04_fw_v03(deviceId);
        break;
    ...
    case Device384PatchClamp_el07e_fw_v07:
        messageDispatcher = new Emcr384PatchClamp_EL07e_fw_v07(deviceId);
        break;

    case Device16PatchClamp_el07e_digitalTesterfw_v01:
        messageDispatcher = new Emcr16PatchClamp_EL07e_DigBrd_fw_v01(deviceId);
        break;
    ...
    case Device24x10MHz_PCBV01_EL05c34:
        messageDispatcher = new Emcr24x10MHz_EL05c34_PCBV01(deviceId);
        break;

    case Device24x10MHz_PCBV02_EL05c1_FWV05:
        messageDispatcher = new Emcr24x10MHz_EL05c1_PCBV02_FWV05(deviceId);
        break;

    case Device24x10MHz_PCBV02_EL05c3_FWV05:
        messageDispatcher = new Emcr24x10MHz_EL05c3_PCBV02_FWV05(deviceId);
        break;

    case Device24x10MHz_PCBV02_EL05c4_FWV05:
        messageDispatcher = new Emcr24x10MHz_EL05c4_PCBV02_FWV05(deviceId);
        break;
...
ErrorCodes_t EmcrOpalKellyDevice::okWriteCalibrationRam(uint16_t address, uint8_t value) {
    ...
    this->stackOutgoingMessage(txStatus, {TxTriggerSetCalRam, ResetIndifferent});
    return Success;
}
