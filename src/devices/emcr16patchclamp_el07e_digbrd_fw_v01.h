#ifndef EMCR16PATCHCLAMP_EL_7E_DIGBRD_FW_V_1_H
#define EMCR16PATCHCLAMP_EL_7E_DIGBRD_FW_V_1_H

#include "emcropalkellydevice.h"

class Emcr16PatchClamp_EL07e_DigBrd_fw_v01 : public EmcrOpalKellyDevice {
public:
    Emcr16PatchClamp_EL07e_DigBrd_fw_v01(std::string di);
...
#endif // EMCR16PATCHCLAMP_EL_7E_DIGBRD_FW_V_1_H
