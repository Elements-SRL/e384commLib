#ifndef EMCR384PATCHCLAMP_EL_7E_FW_V_5_H
#define EMCR384PATCHCLAMP_EL_7E_FW_V_5_H

#include "emcropalkellydevice.h"

class Emcr384PatchClamp_EL07e_fw_v05 : public EmcrOpalKellyDevice {
public:
    Emcr384PatchClamp_EL07e_fw_v05(std::string di);
...
#endif // EMCR384PATCHCLAMP_EL_7E_FW_V_5_H
