...
/** \todo MPAC, recheck, ho cambiato solo i coder rispetto a vHold*/
ErrorCodes_t MessageDispatcher::setVoltageHalfTuner(std::vector<uint16_t> channelIndexes, std::vector<Measurement_t> voltages, bool applyFlag){
...
/** \todo MPAC, recheck, ho cambiato solo i coder rispetto a vHold*/
ErrorCodes_t MessageDispatcher::setCurrentHalfTuner(std::vector<uint16_t> channelIndexes, std::vector<Measurement_t> currents, bool applyFlag){
...
ErrorCodes_t MessageDispatcher::getVoltageHalfTunerFeatures(std::vector <RangedMeasurement_t> &voltageHalfTunerFeatures){
    if (vHalfTunerCoders.empty()) {
        return ErrorFeatureNotImplemented;
...
ErrorCodes_t MessageDispatcher::getCurrentHalfTunerFeatures(std::vector <RangedMeasurement_t> &currentHalfTunerFeatures){
    if (cHalfTunerCoders.empty()) {
        return ErrorFeatureNotImplemented;
